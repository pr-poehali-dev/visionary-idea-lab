...
const testimonials = [
  ...
  {
    quote:
      "Поставщик требовал УПД с кодами маркировки, а наш бухгалтер не знал как это оформить. Обратились в МаркировкаПро — всё сделали за несколько часов. Теперь постоянно пользуемся их услугами.",
    name: "Сергей",
    role: "Оптовый поставщик обуви",
  },
  {
    quote:
      "Пришла проверка и нашла ошибки в учёте маркировки. МаркировкаПро помогли разобраться с проблемами и выстроить правильный процесс. Теперь у нас всё в порядке и я сплю спокойно.",
    name: "Наталья",
